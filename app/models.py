...
class Internship(db.Model):
    ...
    internship_mode = db.Column(db.String(100), nullable=False)
    stipend = db.Column(db.String(100), nullable=False)
    stipend_amount = db.Column(db.String(100))
    ppo = db.Column(db.String(255), default="No")
